...
public class Webserver implements Runnable {
    ...
    public static void main(String[] args) {
        Webserver s = new Webserver(null);
        new Thread(s).start();
    }
    ...
    public void run() {
        ...
        try {
            ...
            if (client != null) {
                client.webserverError("Could not listen to port "+port);
            }
            stop();
            return;
        }
            ...
            try (OutputStream output = connection.getOutputStream()) {
                ...
                if (request.toLowerCase().startsWith("get /token/")) {
                    ...
                    if (token.isEmpty()) {
                        ...
                        if (client != null) {
                            client.webserverTokenReceived(token);
                        }
                    }
                }
