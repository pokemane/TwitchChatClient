...
//            }
    ...
    public static interface ItemEditor<T> {
         ...
         * 
         * @param preset The item to fill the GUI with initially
         * @param c The parent component
         * @param edit Whether this item is edited or added (might set the
         * title accordingly for example)
         * @return The changed or added item, or null if the action was canceled
         */
