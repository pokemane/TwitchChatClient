...
public class NotificationSettings extends SettingsPanel {
    ...
    public NotificationSettings(SettingsDialog d) {
        ...
        useCustom = d.addBooleanSetting("useCustomNotifications",
        ...
        userActivity = d.addBooleanSetting("nActivity", "No User Activity:",
        ...
        requestFollowedStreams = d.addBooleanSetting("requestFollowedStreams",
